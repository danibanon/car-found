...
public final class UStringsKt {
    ...
    public static final String m1476toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1478toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1477toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1475toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m258constructorimpl(255)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m258constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        while (i2 < length) {
            ...
            result = ULong.m337constructorimpl(ULong.m337constructorimpl(((long) UInt.m258constructorimpl(digit)) & 4294967295L) + result2);
