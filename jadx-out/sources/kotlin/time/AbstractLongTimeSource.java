...
public abstract class AbstractLongTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class LongTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark mo1480minusLRDsOJo(long duration) {
        ...
        public long mo1479elapsedNowUwyO8pc() {
            return Duration.m1524minusLRDsOJo(LongSaturatedMathKt.saturatingOriginsDiff(this.timeSource.adjustedRead(), this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo */
        public ComparableTimeMark mo1482plusLRDsOJo(long duration) {
            DurationUnit unit = this.timeSource.getUnit();
            if (Duration.m1521isInfiniteimpl(duration)) {
                return new LongTimeMark(LongSaturatedMathKt.m1618saturatingAddNuflL3o(this.startedAt, unit, duration), this.timeSource, Duration.INSTANCE.m1592getZEROUwyO8pc(), null);
            }
            long durationInUnit = Duration.m1541truncateToUwyO8pc$kotlin_stdlib(duration, unit);
            long rest = Duration.m1525plusLRDsOJo(Duration.m1524minusLRDsOJo(duration, durationInUnit), this.offset);
            long sum = LongSaturatedMathKt.m1618saturatingAddNuflL3o(this.startedAt, unit, durationInUnit);
            long restInUnit = Duration.m1541truncateToUwyO8pc$kotlin_stdlib(rest, unit);
            long sum2 = LongSaturatedMathKt.m1618saturatingAddNuflL3o(sum, unit, restInUnit);
            long restUnderUnit = Duration.m1524minusLRDsOJo(rest, restInUnit);
            long restUnderUnitNs = Duration.m1509getInWholeNanosecondsimpl(restUnderUnit);
            if (sum2 != 0 && restUnderUnitNs != 0 && (sum2 ^ restUnderUnitNs) < 0) {
                ...
                sum2 = LongSaturatedMathKt.m1618saturatingAddNuflL3o(sum2, unit, correction);
                restUnderUnit = Duration.m1524minusLRDsOJo(restUnderUnit, correction);
            }
            long newValue = sum2;
            long newOffset = (((newValue - 1) | 1) > Long.MAX_VALUE ? 1 : (((newValue - 1) | 1) == Long.MAX_VALUE ? 0 : -1)) == 0 ? Duration.INSTANCE.m1592getZEROUwyO8pc() : restUnderUnit;
        ...
        public long mo1481minusUwyO8pc(ComparableTimeMark other) {
            ...
            return Duration.m1525plusLRDsOJo(startedAtDiff, Duration.m1524minusLRDsOJo(this.offset, ((LongTimeMark) other).offset));
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof LongTimeMark) && Intrinsics.areEqual(this.timeSource, ((LongTimeMark) other).timeSource) && Duration.m1494equalsimpl0(mo1481minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1592getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return (Duration.m1517hashCodeimpl(this.offset) * 37) + Long.hashCode(this.startedAt);
        }

        public String toString() {
            return "LongTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1538toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new LongTimeMark(adjustedRead(), this, Duration.INSTANCE.m1592getZEROUwyO8pc(), null);
    }
}
