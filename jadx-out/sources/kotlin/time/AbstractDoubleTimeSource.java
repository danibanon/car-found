...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1479elapsedNowUwyO8pc() {
            return Duration.m1524minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1482plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1525plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1481minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1494equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1521isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1592getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1524minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m1494equalsimpl0(startedAtDiff, Duration.m1542unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m1592getZEROUwyO8pc() : Duration.m1525plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1494equalsimpl0(mo1481minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1592getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1517hashCodeimpl(Duration.m1525plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1538toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1592getZEROUwyO8pc(), null);
    }
}
