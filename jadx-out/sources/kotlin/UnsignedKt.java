...
public final class UnsignedKt {
    ...
    public static final int m514uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m258constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }
    ...
    public static final long m516ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m337constructorimpl(Long.compareUnsigned(v1, v2) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
        ...
        return ULong.m337constructorimpl(((long) (Long.compareUnsigned(ULong.m337constructorimpl(rem), ULong.m337constructorimpl(v2)) < 0 ? 0 : 1)) + quotient);
    }
    ...
    public static final long m517ulongRemaindereb3DHEI(long v1, long v2) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compareUnsigned(ULong.m337constructorimpl(rem), ULong.m337constructorimpl(v2)) >= 0) {
            j = v2;
        }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= 2.147483647E9d ? UInt.m258constructorimpl((int) v) : UInt.m258constructorimpl(UInt.m258constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m258constructorimpl(Integer.MAX_VALUE));
    }
