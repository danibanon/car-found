        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                ...
                case 1:
                    ...
                    SequenceScope sequenceScope2 = (SequenceScope) c00521.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                ...
                c00521.label = 1;
                if (sequenceScope.yield(objRemoveLast, c00521) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    static final class C00471<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            while (it.hasNext()) {
                ...
                c00471.I$0 = i2;
                c00471.label = 1;
                if (sequenceScope.yieldAll(c00471.$iterator.invoke((C) objInvoke), c00471) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
