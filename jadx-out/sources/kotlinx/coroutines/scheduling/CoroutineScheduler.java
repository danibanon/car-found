...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    /* JADX INFO: compiled from: CoroutineScheduler.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0007\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, d2 = {"Lkotlinx/coroutines/scheduling/CoroutineScheduler$WorkerState;", "", "(Ljava/lang/String;I)V", "CPU_ACQUIRED", "BLOCKING", "PARKING", "DORMANT", "TERMINATED", "kotlinx-coroutines-core"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public final void parkedWorkersStackTopUpdate(Worker worker, int oldIndex, int newIndex) {
        ...
        while (true) {
            ...
            if (updIndex >= 0 && parkedWorkersStack$volatile$FU.compareAndSet(this, top, updVersion | ((long) updIndex))) {
                return;
            }
        }
    }
    ...
    public final boolean parkedWorkersStackPush(Worker worker) {
        ...
        } while (!parkedWorkersStack$volatile$FU.compareAndSet(this, top, updVersion | ((long) updIndex)));
        return true;
    }
    ...
    */
    private final int createNewWorker() throws java.lang.Throwable {
        /*
            ...
            monitor-enter(r3)
            r0 = 0
            boolean r6 = r22.isTerminated()     // Catch: java.lang.Throwable -> Lb2
            if (r6 == 0) goto L13
            monitor-exit(r3)
            r0 = -1
            return r0
        ...
        L46:
            r14 = r22
            r15 = 0
            java.util.concurrent.atomic.AtomicLongFieldUpdater r13 = access$getControlState$volatile$FU()     // Catch: java.lang.Throwable -> Lb2
            long r17 = r13.get(r14)     // Catch: java.lang.Throwable -> Lb2
            r13 = r4
            r19 = r5
            long r4 = r17 & r10
            int r4 = (int) r4
            ...
            int r4 = r4 + r5
            if (r4 <= 0) goto L67
            kotlinx.coroutines.internal.ResizableAtomicArray<kotlinx.coroutines.scheduling.CoroutineScheduler$Worker> r14 = r1.workers     // Catch: java.lang.Throwable -> L65
            java.lang.Object r14 = r14.get(r4)     // Catch: java.lang.Throwable -> L65
            if (r14 != 0) goto L67
            r14 = r5
            goto L68
        L65:
        ...
        L68:
            if (r14 == 0) goto La6
            kotlinx.coroutines.scheduling.CoroutineScheduler$Worker r14 = new kotlinx.coroutines.scheduling.CoroutineScheduler$Worker     // Catch: java.lang.Throwable -> L65
            r14.<init>(r1, r4)     // Catch: java.lang.Throwable -> L65
            r2 = r14
            kotlinx.coroutines.internal.ResizableAtomicArray<kotlinx.coroutines.scheduling.CoroutineScheduler$Worker> r14 = r1.workers     // Catch: java.lang.Throwable -> L65
            r14.setSynchronized(r4, r2)     // Catch: java.lang.Throwable -> L65
            r14 = r22
            r15 = 0
            java.util.concurrent.atomic.AtomicLongFieldUpdater r5 = getControlState$volatile$FU()     // Catch: java.lang.Throwable -> L65
            long r20 = r5.incrementAndGet(r14)     // Catch: java.lang.Throwable -> L65
            r5 = r14
            r18 = 0
            long r10 = r20 & r10
            int r5 = (int) r10
        ...
        L9a:
            ...
            java.lang.IllegalArgumentException r10 = new java.lang.IllegalArgumentException     // Catch: java.lang.Throwable -> L65
            java.lang.String r5 = r5.toString()     // Catch: java.lang.Throwable -> L65
            r10.<init>(r5)     // Catch: java.lang.Throwable -> L65
