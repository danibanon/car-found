...
@Metadata(d1 = {"\u0000\u0019\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u001c\u0010\u0002\u001a\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00028\u00000\u0005H\u0096@¢\u0006\u0002\u0010\u0006¨\u0006\u0007¸\u0006\u0000"}, d2 = {"kotlinx/coroutines/flow/internal/SafeCollector_commonKt$unsafeFlow$1", "Lkotlinx/coroutines/flow/Flow;", "collect", "", "collector", "Lkotlinx/coroutines/flow/FlowCollector;", "(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
        ...
        L2d:
            ...
            kotlin.ResultKt.throwOnFailure(r0)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L34
            goto L62
        L34:
            r2 = move-exception
            goto L66
        L36:
            ...
            r5.<init>()
            kotlinx.coroutines.flow.Flow r6 = r2.$this_take$inlined     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L63
            kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1 r7 = new kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L63
            int r8 = r2.$count$inlined     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L63
            r7.<init>(r5, r8, r10, r4)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L63
            kotlinx.coroutines.flow.FlowCollector r7 = (kotlinx.coroutines.flow.FlowCollector) r7     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L63
            r11.L$0 = r4     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L63
            r8 = 1
            r11.label = r8     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L63
            java.lang.Object r6 = r6.collect(r7, r11)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L63
            if (r6 != r1) goto L60
            return r1
        L60:
            r10 = r3
