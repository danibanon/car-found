...
public interface ReceiveChannel<E> {
    ...
    Object mo1669receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1670tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1670tryReceivePtdJZtk = receiveChannel.mo1670tryReceivePtdJZtk();
            if (ChannelResult.m1686isSuccessimpl(objMo1670tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1682getOrThrowimpl(objMo1670tryReceivePtdJZtk);
            }
            Throwable thM1680exceptionOrNullimpl = ChannelResult.m1680exceptionOrNullimpl(objMo1670tryReceivePtdJZtk);
            if (thM1680exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1680exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L38:
                ...
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1681getOrNullimpl(r3)
                return r3
            */
