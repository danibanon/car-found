...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo1669receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m1667receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            $this$resumeWithStackTrace$iv.resumeWith(Result.m163constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            $this$resumeWithStackTrace$iv2.resumeWith(Result.m163constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
        }
    ...
    */
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuation.resumeWith(Result.m163constructorimpl(ResultKt.createFailure(exception$iv)));
    }
            ...
            while (true) {
                ...
                if (segment$iv3.id != id$iv) {
                    ...
                    if (segment$iv4 != null) {
                        ...
                        return ChannelResult.INSTANCE.m1689closedJP2dKIU(getSendException());
                    }
                } else {
                ...
                switch (updateCellSend(segment$iv, i$iv, element, $this$sendersCounter$iv$iv, waiter$iv, closed$iv)) {
                    case 0:
                        ...
                        return ChannelResult.INSTANCE.m1691successJP2dKIU(Unit.INSTANCE);
                    case 1:
                        return ChannelResult.INSTANCE.m1691successJP2dKIU(Unit.INSTANCE);
                    case 2:
                        if (closed$iv) {
                        ...
                        segm.onSlotCleaned();
                        return ChannelResult.INSTANCE.m1690failurePtdJZtk();
                    case 3:
        ...
        while (true) {
            ...
            switch (bufferedChannel.updateCellSend(segment$iv, i$iv, e, $this$sendersCounter$iv$iv, waiter$iv, closed$iv)) {
                case 0:
                    ...
                    Result.Companion companion2 = Result.INSTANCE;
                    cont.resumeWith(Result.m163constructorimpl(Boxing.boxBoolean(true)));
                    break;
                case 1:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0088, code lost:
        ...
        return kotlinx.coroutines.channels.ChannelResult.INSTANCE.m1689closedJP2dKIU(getSendException());
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected final java.lang.Object m1671trySendDropOldestJP2dKIU(E r21) {
        /*
            Method dump skipped, instruction units count: 240
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m1671trySendDropOldestJP2dKIU(java.lang.Object):java.lang.Object");
    }
    ...
    private final boolean tryResumeReceiver(Object $this$tryResumeReceiver, E e) {
        ...
        if ($this$tryResumeReceiver instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM1676boximpl = ChannelResult.m1676boximpl(ChannelResult.INSTANCE.m1691successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM1676boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, ((ReceiveCatching) $this$tryResumeReceiver).cont.getContext()) : null);
        }
                ...
                if (updCellResult$iv != BufferedChannelKt.SUSPEND) {
                    try {
                        if (updCellResult$iv != BufferedChannelKt.FAILED) {
                            ...
                            ChannelSegment segment$iv$iv2 = (ChannelSegment) getReceiveSegment$volatile$FU().get(this);
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m163constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    static /* synthetic */ <E> java.lang.Object m1667receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r17, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r18) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 240
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m1667receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object m1668receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r28, int r29, long r30, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r32) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 444
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m1668receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m163constructorimpl(ChannelResult.m1676boximpl(ChannelResult.INSTANCE.m1689closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo1670tryReceivePtdJZtk() {
        ChannelSegment segment$iv;
        ...
        if (isClosedForReceive0(sendersAndCloseStatusCur)) {
            return ChannelResult.INSTANCE.m1689closedJP2dKIU(getCloseCause());
        }
        long $this$sendersCounter$iv = sendersAndCloseStatusCur & 1152921504606846975L;
        ...
        while (!isClosedForReceive()) {
            ...
            if (updCellResult$iv != BufferedChannelKt.SUSPEND) {
                if (updCellResult$iv != BufferedChannelKt.FAILED) {
                    ...
                    segment$iv4.cleanPrev();
                    return ChannelResult.INSTANCE.m1691successJP2dKIU(updCellResult$iv);
                }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m1676boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m1689closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m1691successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
                    ...
                    if (updCellResult$iv != BufferedChannelKt.SUSPEND) {
                        try {
                            if (updCellResult$iv != BufferedChannelKt.FAILED) {
                                ...
                                ChannelSegment segment$iv$iv2 = (ChannelSegment) BufferedChannel.getReceiveSegment$volatile$FU().get(bufferedChannel);
                                while (!bufferedChannel.isClosedForReceive()) {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (cause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m163constructorimpl(false));
                return;
            }
            ...
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuationImpl2.resumeWith(Result.m163constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
        }
    ...
    */
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
        Object suspendedReceivers = InlineList.m1712constructorimpl$default(null, 1, null);
            ...
            for (int index = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < index; index--) {
                ...
                while (true) {
                    ...
                    if (state == null || state == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (channelSegment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            suspendedReceivers = InlineList.m1717plusFjFbRPM(suspendedReceivers, ((WaiterEB) state).waiter);
                        ...
                        if (channelSegment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            suspendedReceivers = InlineList.m1717plusFjFbRPM(suspendedReceivers, state);
                            channelSegment.onCancelledRequest(index, true);
                            break;
                        }
                    }
    ...
    private final void resumeWaiterOnClosedChannel(Waiter $this$resumeWaiterOnClosedChannel, boolean receiver) {
        if (!($this$resumeWaiterOnClosedChannel instanceof SendBroadcast)) {
            if (!($this$resumeWaiterOnClosedChannel instanceof CancellableContinuation)) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m163constructorimpl(ChannelResult.m1676boximpl(ChannelResult.INSTANCE.m1689closedJP2dKIU(getCloseCause()))));
                return;
            }
            Continuation continuation = (Continuation) $this$resumeWaiterOnClosedChannel;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m163constructorimpl(ResultKt.createFailure(receiver ? getReceiveException() : getSendException())));
            return;
        }
        CancellableContinuation<Boolean> cont = ((SendBroadcast) $this$resumeWaiterOnClosedChannel).getCont();
        Result.Companion companion3 = Result.INSTANCE;
        cont.resumeWith(Result.m163constructorimpl(false));
    }
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        do {
            ...
            if (SegmentOrClosed.m1729isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1727getSegmentimpl(s$iv);
            while (true) {
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m1727getSegmentimpl(s$iv);
        if (channelSegment.id > id) {
