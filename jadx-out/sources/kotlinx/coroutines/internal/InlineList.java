...
public final class InlineList<E> {
    ...
    public boolean equals(Object obj) {
        return m1713equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1716hashCodeimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1712constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1711constructorimpl(obj);
    }

    /* JADX INFO: renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m1717plusFjFbRPM(Object arg0, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (arg0 == null) {
            return m1711constructorimpl(e);
        }
        if (arg0 instanceof ArrayList) {
            ...
            return m1711constructorimpl(arg0);
        }
        ArrayList list = new ArrayList(4);
        list.add(arg0);
        list.add(e);
        return m1711constructorimpl(list);
    }

    /* JADX INFO: renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m1715forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
